...
<html>
    ...
    <h1 class="h1" style="text-align: center; font-weight: bold; letter-spacing: 10px"> File List </h1>
        
        <table class="table table-striped table-hover"> 
            <tr><th><h3>File</h3></th><th><h3>Type</h3></th><th><h3>Link</h3></th><th><h3>Preview</h3></th></tr>
            <?php        
                ...
                foreach($filelist as $file):?> 
                    <?php $type = strtoupper(array_search(finfo_file($info, './uploads/'.$file),$FileTypes));?>
